...
kubectl logs deployment/ingestor-server --tail=100 2>/dev/null | grep -E "Time taken:" | tail -20
...
kubectl logs deployment/ingestor-server --since=10m 2>/dev/null | grep -E "(Processing|batch|complete|documents)" | tail -10
