...
def index():
    ...
    <body>
        <div class="container">
            <h1>🔌 MCP Services Control Panel</h1>
...
if __name__ == '__main__':
    ...
    print("🌐 MCP Settings Panel will be available at http://localhost:8081")
    print("🔌 Features: Enable/Disable MCP Services, Auto-connect Settings")
