...
print('=== Testing RAG Server Search with hammerspace_docs Collection ===')

# Test search endpoint with the newly created hammerspace_docs collection
search_data = {
    "query": "NVIDIA RAG Blueprint",
...
# Test the generate endpoint to see if it can use the collection
generate_data = {
    "messages": [
        {"role": "user", "content": "What can you tell me about NVIDIA RAG Blueprint?"}
    ],
    "collection_names": ["hammerspace_docs"],
