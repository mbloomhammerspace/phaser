...
def clear_and_recreate_collection():
    ...
    schema = CollectionSchema(fields, description="Hammerspace documents for RAG Blueprint (LangChain compatible)")
...
def main():
    print("=== Clearing Database and Re-ingesting HammerSpace PDFs ===")
